...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $title ?? (isset($header) ? trim(strip_tags($header)) : config('app.name', 'Laravel')) }}</title>
        ...
        <!-- Alpine (you already had this; fine to keep) -->
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-[#D9D9D9] dark:bg-gray-900">
            ...
            <!-- Page Heading -->
            @if (isset($header))
                <header class="bg-[#F0F8FF] dark:bg-gray-800 shadow">

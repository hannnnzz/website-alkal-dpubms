<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('admin.alat-sewa-types.update', $alat->id) }}" method="POST" class="bg-white dark:bg-gray-800 shadow rounded px-6 py-4">
                @csrf
                @method('PUT')

                <div class="mb-4">
                    <label for="name" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Nama Alat</label>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('admin.alat-sewa-types.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded">Batal</a>
                </div>
            </form>
        </div>
    </div>
